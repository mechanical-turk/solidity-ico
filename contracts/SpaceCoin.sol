...
contract SpaceCoin is ERC20 {
     ...
     *          The collective total maximum is only limited by the total supply, which is 500_000 tokens.
    ...
    /**
     * @dev The ERC-20 transferFrom method is extended for taxing purposes.
     */
    function transferFrom(
        ...
        (uint256 taxAmount, uint256 remainder) = applyTax(amount);
        if (taxAmount > 0) {
            super.transferFrom(from, treasury, taxAmount);
        }
        return super.transferFrom(from, to, remainder);
    }

    /**
     * @dev The ERC-20 transfer method is extended for taxing purposes.
     */
